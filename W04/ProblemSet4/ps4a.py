...
WORDLIST_FILENAME = "F:\Dev\Python\MITx6001\W04\ProblemSet4\words.txt"
...
def playGame(wordList):
    ...
    """
    hand = None
    input_user = raw_input("Enter n to deal a new hand, r to replay the last hand, " + 
        "or e to end game: ")
    ...
    while input_user != "e":
        ...
        input_user = raw_input("Enter n to deal a new hand, r to replay the last " + 
