...
class edx(object):
    ...
    def setGrade(self, grade, course="6.01x"):
        ...
        """
        for course_info_curr in self.myCourses:
            if course_info_curr.courseName == course:
                course_info_curr.setGrade(grade)
    ...
    def getGrade(self, course="6.02x"):
        ...
        for course_info_curr in self.myCourses:
            if course_info_curr.courseName == course:
                return course_info_curr.getGrade()
        return -1
    ...
    def setPset(self, pset, score, course="6.00x"):
        ...
        for course_info_curr in self.myCourses:
            if course_info_curr.courseName == course:
                course_info_curr.setPset(str(pset), score)
    ...
    def getPset(self, pset, course="6.00x"):
        ...
        for course_info_curr in self.myCourses:
            if course_info_curr.courseName == course:
                return course_info_curr.getPset(str(pset))
        return -1
